...
df_all["num_demes"] = df_all["graph_name"].apply(lambda x: x.split("_")[1])
df_all["num_edge_added"] = df_all["graph_name"].apply(lambda x: x.split("_")[2])
df_all["beta"] = df_all["graph_name"].apply(lambda x: int(x.split("_")[3].split("m")[-1]))
df_all["graph_rep"] = df_all["graph_name"].apply(lambda x: x.split("_")[4])
